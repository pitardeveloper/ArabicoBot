...
// playing
client.on('ready', () => {
                                                                                                                                                                                                                                                                              client.user.setGame(`ArabicBot | Type !help For Help.`,'https://www.twitch.tv/kimomixpro');
});
...
السلام وعليكم ورحمة الله وبركاته نقدم لكم بوت اسطوووري وجدييد
بوت جديد في الديسكورد : :new: 
شغال 24 ساعة متواصلة بدون توقف : :white_check_mark: 
برمجة خورافية للبوووووت : :cool: 
...
!credit              |  لتعرف فلوسك
!suggest             | للأقتراح في روم الاقتراحات
...
ملاحظة : امر صناعة روم صوتي وكتابي تحت الصيانة 
